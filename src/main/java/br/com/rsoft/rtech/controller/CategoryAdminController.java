...
import br.com.rsoft.rtech.model.CategoryRegistrationData;
...
public class CategoryAdminController {
    ...
    @Transactional
    public String saveCategory(@Valid CategoryRegistrationData data, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            System.out.println("Wrong fields: ");
    ...
    @PostMapping(value = "/{code}", consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_FORM_URLENCODED_VALUE})
    @Transactional
    public String updateCategoryByCode(@PathVariable String code, @Valid CategoryRegistrationData data, BindingResult bindingResult) {
